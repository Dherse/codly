...
#let codly = {
  ...
  e.element.declare(
    ...
    fields: (
      ...
      e.field("skip-line", e.types.option(content), doc: __doc("skip-line"), default: __default("skip-line")),
      e.field("skip-number", e.types.option(content), doc: __doc("skip-number"), default: __default("skip-number")),
