...
#show: codly.highlight-set_(color: red, fill: color => color, stroke: color => color + 1pt, clip: false)
...
#check((blue, green + 2pt, true, 3pt), codly.codly-highlight([word], highlight: (
  line: 1, fill: blue, stroke: green + 2pt, clip: true, baseline: 3pt,
)))
#check((blue, blue + 1pt, false, 0pt), codly.codly-highlight([word], highlight: (
  line: 1, fill: color => { assert.eq(color, red); blue },
)))
