...
fmt:
	typstyle --inplace --line-width 100 --indent-width 2 --no-reorder-import-items codly.typ src tests docs

# verify Typst formatting without changing files
fmt-check:
	typstyle --check --line-width 100 --indent-width 2 --no-reorder-import-items codly.typ src tests docs
